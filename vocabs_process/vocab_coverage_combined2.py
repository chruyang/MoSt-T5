...
# ================= 绝对路径与配置 =================
BASE_DIR = os.path.expanduser("~/autodl-tmp/e3fp-chebi-molgen/data")

SPLITS = {
    "Train": os.path.join(BASE_DIR, "train-00000-of-00001-98179f3c7ae9a14d.parquet"),
    # 注意：如果 Valid 和 Test 实际文件名不同，请在此处修正
    "Valid": os.path.join(BASE_DIR, "validation-00000-of-00001-aa1e794fde3e680c.parquet"),
    "Test":  os.path.join(BASE_DIR, "test-00000-of-00001-da133697d980844a.parquet")
}
...
def main():
    print("🚀 开始进行【PubChemQC + 下游 chebi Train 增强】的混合词表覆盖率测试...")
