"""Anchored 3D-MotifT5 with the reference-aligned fixed-four atom encoder."""
...
FACTORISATION_ID = (
    "most-t5-p2/factorized-motif-geometry-t5/v5-reference-fixed4-anchored"
)


class FactorizedMotifT5V5(FactorizedMotifT5V3):
    """Reuse V3 routing while constructing exactly one V5 adapter."""
    ...
    def __init__(
        ...
        *,
        ...
        self.adapter = MotifGeometryAdapterV5(
...
__all__ = ["FACTORISATION_ID", "FactorizedMotifT5V5"]
