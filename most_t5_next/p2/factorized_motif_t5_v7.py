"""Anchored 3D-MotifT5 with the one-linear L0/high-shell reducer."""
...
from .motif_geometry_adapter_v7 import MotifGeometryAdapterV7


FACTORISATION_ID = "most-t5-p2/factorized-motif-geometry-t5/v7-linear-l0-high"


class FactorizedMotifT5V7(FactorizedMotifT5V3):
    """Reuse V3 carrier/endpoint routing with exactly one V7 adapter."""
    ...
    def __init__(
        ...
        *,
        ...
        self.adapter = MotifGeometryAdapterV7(
...
__all__ = ["FACTORISATION_ID", "FactorizedMotifT5V7"]
