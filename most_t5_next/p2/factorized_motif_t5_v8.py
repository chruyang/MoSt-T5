"""Anchored 3D-MotifT5 with the minimal nonlinear L0/high atom phi."""
...
FACTORISATION_ID = "most-t5-p2/factorized-motif-geometry-t5/v8-minimal-phi"


class FactorizedMotifT5V8(FactorizedMotifT5V3):
    def __init__(
        self,
        t5_model: nn.Module,
        *,
        ...
        self.adapter = MotifGeometryAdapterV8(
...
__all__ = ["FACTORISATION_ID", "FactorizedMotifT5V8"]
