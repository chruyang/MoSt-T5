"""Anchored 3D-MotifT5 with the level-aware minimal atom phi."""
...
from .motif_geometry_adapter_v9 import MotifGeometryAdapterV9


FACTORISATION_ID = "most-t5-p2/factorized-motif-geometry-t5/v9-level-aware-phi"


class FactorizedMotifT5V9(FactorizedMotifT5V3):
    def __init__(
        self,
        t5_model: nn.Module,
        *,
        ...
        hidden_size = FactorizedMotifT5V1._bind_t5_boundary(
            self, t5_model=t5_model, state_level2_weight=state_level2_weight
        )
        self.adapter = MotifGeometryAdapterV9(
...
__all__ = ["FACTORISATION_ID", "FactorizedMotifT5V9"]
