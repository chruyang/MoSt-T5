...
AUDIT_CONTRACT_SCHEMA = "most-t5-r1/p1-pcqm-geometry-independent-audit-contract/v2"
AUDIT_REPORT_SCHEMA = "most-t5-r1/p1-pcqm-geometry-independent-audit-report/v2"
SEMANTIC_PLAN_SCHEMA = "most-t5-r1/p1-pcqm-geometry-semantic-review-plan/v2"
...
def audit_release(release_root, audit_contract_path, production_contract_path,
    ...
    report = {
        ...
        "audit_status": "pass",
        "audit_class": "independent_full_envelope_and_deterministic_sampled_payload_v2",
        "release_id": release_id,
        "release_manifest_sha256": release_manifest_sha,
        "audit_contract_sha256": audit_contract_sha,
        "production_contract_sha256": sha256_file(production_contract_path),
        "payload_contract_sha256": sha256_file(payload_contract_path),
        "counts": {
